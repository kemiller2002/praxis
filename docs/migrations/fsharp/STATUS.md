...
Last updated: 2026-09-10 (post telemetry-lifecycle-bookkeeping slice, Phase A/MIG-08's second increment, closing the `time.blocked_ms`-is-always-zero gap left open since `work resume`/`work block`). Production authority remains Node.
