...
Last updated: 2026-09-07. Production authority remains Node.
...
- **To F# core/commands:** artifact rules/projection first; later work,
  execution, telemetry, evidence, configured stable policy, Git provenance,
  initialization/upgrade, and release-plan decisions.
