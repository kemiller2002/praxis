...
touched. Everything still missing from Phase 1 (every non-generic
...
still-open rows to "full parity" (twenty-one of twenty-six), not yet
reflected in a new formal re-run, since a small row delta does not
warrant its own evidence record
